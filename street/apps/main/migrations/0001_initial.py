# Generated by Django 2.2.6 on 2019-12-25 15:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=django.utils.timezone.now, verbose_name='Дата затвердження документу')),
                ('path_pdf', models.TextField(blank=True, default='', verbose_name='Шлях до PDF')),
                ('pub_date', models.DateField(default=datetime.date.today, verbose_name='Дата додавання документу')),
                ('name', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='dictionaries.DictStreetOperations', verbose_name='Назва документу')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=django.utils.timezone.now, verbose_name='Дата проведення операції над сегментом')),
                ('document', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='main.DocumentsStreet')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=django.utils.timezone.now, verbose_name='Дата проведення операції над парою вулиця-сегмент')),
                ('document', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='main.DocumentsStreet')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=django.utils.timezone.now, verbose_name='Дата проведення операції над вулицею')),
                ('document', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='main.DocumentsStreet')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('segment', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='main.Segment')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='', max_length=100, verbose_name='Назва вулиці')),
                ('street', models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='main.Street')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='street',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.DO_NOTHING, to='main.Street'),
        ),
        migrations.AddField(
